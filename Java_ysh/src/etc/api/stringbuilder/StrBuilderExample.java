...
public class StrBuilderExample {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - String 클래스 단점으로 인한 멤리 과부하 및 속도가 느려지는 현상을 개선하기 위해서
		 StringBuilder가 새롭게 추가되었습니다.
		 
		 -StringBuilder는 기존 객체를 계쏙 재활용하면서 실제 객체 내부의 값을 변경하게됩니다.
		 
		 -StringBuilder, StringBuffer는 메서드가 동일합니다.
		 StringBUilder -> 단일 스레드
		 StringBuffer -> 다중 스레드에서 문자열을 공유해야할때
