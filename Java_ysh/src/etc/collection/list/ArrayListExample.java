...
public class ArrayListExample {
	...
	public static void main(String[] args) {
		...
		nick.add("짹짹이");
		nick.add("야옹이"); //객체 중복저장 허용
		System.out.println(nick);
		
		//add(인덱스, 객체): 특정 인데스에 객체를 삽입하는메서드
		...
		System.out.println(nick.contains("고양이"));
		
		//clear() : 리스트 내부 용소 전체 삭제
		nick.clear();
		System.out.println(nick);
		
		// isEmpty() : 리스트가 비어있는지의 ㅎ여부 확인
		System.out.println(nick.isEmpty());
		
		//#컬랙션 객체들은 collections의 기능을 사용할수있습니다.
		//Collections는 컬렉션 객체들의 부가 기능들은지원합니다
