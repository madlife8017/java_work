...
public class HashSetExample {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 # Hash
		 - 어떤값을 넣었을 때 전혀 예측하지 못할 값이 생성되어야 하는 알고리즘
		...
		/*
		 - set은 인덱스가 없기 때문에 메서드를 이요해서 객체를 얻는게 아니라
		...
		/*
		 Iterator 객체의 메서드 next()를 통해 내부요소를 하나씩 꺼내올수 있습니다.
		 next()를 요소의 개수보다 많이 호출하게 되면
		 NoSuchElement 예외가 발생합니다.
		 hasNext() -> 반복자가 가지고 있는 객체를 더 가지고 올수있는지의 여부를
		 확인하는 메서드를 통해 next()를 호출하셔야 합니다.
		 */
		...
		}//set 데이터 꺼낼땐 무조건 향상포문
		
		//set에서 객체를 삭제 : remove(객체) set은 인덱스 없음
