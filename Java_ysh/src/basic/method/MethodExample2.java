...
/*
 ...
 3. 매개값을 몇 개 받아서 사용할지는 메서드를 선언할 때 선언부에서 ()안에 미리
 개수와 타입을 지정합니다.
 
 4. 매개 변수의 이름을 지을 때는 호출자가 선언부로 돌아와서 매개값을 확인하지않게
 어떠한 값을 담는 변수인지 그뜻으 알기 쉽게 지어주면 서로에 좋습니다.
 
 5.매개변수를 하나도 선언하지 않을 수도 있습니다. 이 때는 메서드의 선언부에()로 비워둡니다.
 그리고 호출할때도 ()를 비워서 선언 
 */
public class MethodExample2 {
	...
	//x~y까지 누적합계를 구하는 메서드
	 ...
	 public static void main(String[] args) {
		 ...
		 //가변 파라미터에 값을 보낼 때는 콤마로 쭉 나열하시거나 배열로 포장해서 보내도 됩니다.
