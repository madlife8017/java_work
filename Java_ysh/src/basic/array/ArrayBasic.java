...
public class ArrayBasic {
	...
	public static void main(String[] args) {
		...
		//2. 배열 객체를 생성 - 실제 값들이 저장될 공간을 형성한다.
		...
		arr[1] = 88;
		arr[2] = arr[0];
		arr[3] = (int)3.14; //배열은 같은 종류까지만 넣기 가능
		//arr[4] = "들어갈까요?";
		arr[4] =100;
		// arr[5] =43; :범위밖임
		...
		//5. 배열의 저장되 ㄴ값을 참조 (사용) 하는 법 (인덱스를 이용한다)
		...
		//6. 배열의 반복문처리
		// 배열은 인덱스 번호를 제어변수로 활용하여 쉽게 반복문을 처리할수 있습니다.
		...
		//9. 배열의 생성고 ㅏ동시에 초기화도 진행하는 방법.
		char[] letters = new char[] {'A' , 'B','C','D'};
		
		System.out.println(Arrays.toString(letters));
		
		//선언과 동시에 초기화를 할때 딱 1번만 가능한 문법
		//배열의 크기가 고정이기 때문에 늘어나거나 줄어들 순 없습니다.
		// 배열의 크기 수정하고 싶다면 기존배열 수정이 아니라 새로생성해야한다.
		String[] names = {"홍길도", "김철수", "박영희"};
		//names =  {"홍길도", "김철수", "박영희"}; (X)
		names = new String [] {"홍길도", "김철수", "박영희","김영희"};
